...
namespace MSBandAzure.Mvvm
{
    ...
    {
        public static void CreateInstance(INavigationService navigationService)
        {
            _instance = new VMLocator(navigationService);
        }
        ...
        public BandViewModel CurrentBand { get; set; }
    }
}

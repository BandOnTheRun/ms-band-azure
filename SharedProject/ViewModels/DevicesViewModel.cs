...
namespace DataSync.ViewModels
{
    public class DevicesViewModel : ViewModelBase
    {
        ...
        {
            AppData.Events.Publish(new BusyProcessing { IsBusy = true, BusyText = "Connecting..." });
            IsBusy = true;
        ...
        private async Task<object> EnumerateBands(object obj)
        {
            ...
            IsBusy = true;
            AppData.Events.Publish(new BusyProcessing { IsBusy = true, BusyText = "Enumerating bands..." });
